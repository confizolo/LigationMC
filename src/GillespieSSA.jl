# Gillespie SSA Implementation of Polymer Growth
#
# This module implements the well-mixed Gillespie direct method for simulating
# the irreversible Smoluchowski equation with cyclisation.
#
# Combinatoric pairing convention:
# We use ordered pairs for same-species merge propensities (ni * (ni-1))
# and ni * nj for different species, matching the conventional SSA scaling.
module GillespieSSA
